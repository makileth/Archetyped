  ...
  return (
    <section className="min-h-[55rem] lg:min-h-[55rem] mx-auto w-full md:max-w-6xl">
      <div className="pl-2 sm:pl-6 xl:pl-0 h-full flex  flex-col md:flex-row justify-between max-w-screen-xl py-8">
        <div className="mt-[6rem] max-w-xl md:mt-[17rem] flex flex-col gap-1  md:w-[40%]">
        ...
        <div className="w-full overflow-hidden pr-10 md:pr-0 pl-0 md:w-[60%] md:pl-2 pt-[5rem] md:pt-[11.5rem] relative lg:mt-0 lg:col-span-5 lg:flex">
          <Image
            className="z-[30] w-full h-full md:scale-[1] scale-[0.9] object-contain"
