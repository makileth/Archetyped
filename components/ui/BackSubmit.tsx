  ...
  return (
    <div className="flex px-2 md:mx-0 w-full my-2 h-max justify-between items-center">
      <button
        ...
        className="text-black hover:border-transparent hover:text-white w-max px-[2rem] h-[2rem] border-[0.5px] border-neutral-200 justify-center items-center bg-white hover:bg-black transition duration-300 rounded-full flex  top-1.5 right-[6rem]"
      >
      ...
      >
        <div className="flex flex-row justify-between items-center mt-[0.10rem]">
          ...
          <div className=" w-[1rem] h-[1rem] justify-center items-center ml-2 bg-primary rounded-full">
            <Image
              src="/assets/submit.svg"
              alt="edit image"
              width={13}
              height={13}
              className="mx-auto mt-[0.10rem] ml-[0.09rem]"
            />
          </div>
        </div>
      </button>
