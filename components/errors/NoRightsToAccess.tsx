...
const NoRightsToAccess = () => {
  ...
  return (
    <main className="text-neutral-900 min-h-[100vh] items-center max-w-4xl mx-auto py-56 mx-2">
      <div className="text-neutral-900 min-h-[100vh] text-center items-center gap-8 flex flex-col ">
